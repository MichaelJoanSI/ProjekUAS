  ...
  <div class="container-fluid mt-4 rounded">
    <form action="/mahasiswa/simpanmahasiswa" method="POST" class="pt-2 pb-2">
        ...
        <div class="form-group w-25">
            <label>NIM</label>
            <input type="number" name="nim" class="form-control" placeholder="Masukan NIM" requeired>
        </div>
        <div class="form-group w-25">
        ...
        <div class="form-check-w-25">
            <input type="radio" name="gender" value="1" class="form-group-input">
            <label>Laki-laki</label>
        </div>
        <div class="form-check-w-25">
            <input type="radio" name="gender" value="2" class="form-group-input">
