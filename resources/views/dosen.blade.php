                          ...
                          @foreach($dosen as $no => $d)
                            <tr>
                              ...
                              <td>
                                ...
                                <a href="/dosen/hapusdosen/{{ $d->id }}" class="btn btn-outline-danger"><i class="bi bi-x-square"></i></a>
                                <a href="/dosen/hapusdosen/{{ $d->id }}" onclick="return confirm('Anda Yakin akan Menghapusnya?');"></a>
                              </td>
                            </tr>
                          @endforeach
                      </tbody>
